  ...
  <transition name="move">
    <div class="addquestions">
      <navheader>
        ...
        <span slot="main_title" class="shou">回复：{{commentUser}}</span>
      </navheader>
...
export default {
  ...
  methods: {
    ...
    that.pId = commentData.commentUser;   //pId为上级评论的创始人的昵称
    that.commentUser = commentData.commentUser;
    // console.log(commentData.commentUser)    
    },
